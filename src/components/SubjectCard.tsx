...
export const SubjectCard = ({ subject, onClick }: SubjectCardProps) => {
  return (
    <Card 
      className="p-2.5 tap-target cursor-pointer transition-all duration-200 hover:shadow-lg active:scale-95 border-2 hover:border-primary/50 h-16 flex items-center"
      onClick={onClick}
    >
